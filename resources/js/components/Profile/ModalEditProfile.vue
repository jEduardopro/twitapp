        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body p-0 pb-5">
                    ...
                    <div
                        v-if="Object.keys(profile_form).length > 0"
                        class="mt-5 px-1 pt-4"
                    >
                        <div class="form-group">
                            <base-input
                                v-model="profile_form.name"
                                @press="minChar($event, 50)"
                                :label="'Nombre'"
                                :inputType="'text'"
                            ></base-input>
                            <span
                            ...
                            ></span>
                            <span class="w-100 d-block text-muted text-right"
                                >{{ profile_form.name.length }}/50</span
                            >
                        </div>
                        <div class="form-group">
                            <base-input
                            ...
                            ></span>
                            <span class="w-100 d-block text-muted text-right"
                                >{{ profile_form.username.length }}/50</span
                            >
                        </div>
                        ...
                        <div class="form-group">
                            <div
                                :class="[
                                    'input-custom',
                                    focus_input ? 'focus-set' : ''
                                ]"
                            >
                                <label class="m-0">Biografía</label>
                                <textarea
                                    rows="3"
                                    @keypress="minChar($event, 159)"
                                    v-model="profile_form.description"
                                    @focus="onFocus(true)"
                                    @blur="onFocus(false)"
                            ...
                            ></span>
                            <span class="w-100 d-block text-muted text-right"
                                >{{ profile_form.description.length }}/160</span
                            >
                        </div>
                    </div>
                </div>
